...
Limpieza_lecturas = ui.page_fluid(
    ...
    ui.layout_columns(
        ui.card("Seleccione sus preferencias para la limpieza de las lecturas:",
                ui.layout_columns(
                ui.card(ui.input_checkbox("check_Q_media", "Restringir calidad media de las lecturas", True),
                        ui.input_numeric("Q_media", "Eliminar lecturas que tengan una calidad media menor que:", 30, min=1, width="100%")),
